...
public class ProductCategoryController {
    ...
    @RequestMapping(value = "/products-category", method = RequestMethod.GET, produces = {APPLICATION_JSON_VALUE})
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "Authorization", value = "Authorization token",
                    required = true, dataType = "string", paramType = "header") })
    @RequestMapping(value = "/products-category", method = RequestMethod.POST, produces = {APPLICATION_JSON_VALUE})
    @PreAuthorize("hasRole('ADMIN')")
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "Authorization", value = "Authorization token",
                    required = true, dataType = "string", paramType = "header") })
    @RequestMapping(value = "/products-category/{productCategoryId}", method = RequestMethod.PUT, produces =
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "Authorization", value = "Authorization token",
                    required = true, dataType = "string", paramType = "header") })
    @RequestMapping(value = "/products-category/{productCategoryId}", method = RequestMethod.DELETE, produces =
            {APPLICATION_JSON_VALUE})
    @PreAuthorize("hasRole('ADMIN')")
